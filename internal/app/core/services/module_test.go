...
func TestModuleService_CreateModule(t *testing.T) {
	...
	_, index := os.Stat("cmd/service/assets/templates/index.tmpl")
	_, login := os.Stat("cmd/service/assets/templates/login.tmpl")
	_, styles := os.Stat("cmd/service/assets/static/styles.css")
